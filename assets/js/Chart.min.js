		...
		42: [function(t, e, i) {
			...
			var n, a = {
				...
				each: function(t, e, i, n) {
					var o, r, s;
					if (a.isArray(t)) if (r = t.length, n) for (o = r - 1; o >= 0; o--) e.call(i, t[o], o);
					else
			...
			e.exports = function(t) {
				var e = t.Scale.extend({
					...
					determineDataLimits: function() {
						...
						for (t = 0, i = (f.data.datasets || []).length; t < i; ++t) if (f.isDatasetVisible(t)) if (l = f.data.datasets[t].data, o.isObject(l[0])) for (y[t] = [], e = 0, a = l.length; e < a; ++e) u = g(l[e], h), x.push(u), y[t][e] = u;
					...
					buildTicks: function() {
						...
						return y.min = k, y.max = M, y._unit = S.unit ||
						function(t, e, i, a) {
